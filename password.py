...
Title = Label(root, text="Password Generator", bg="grey", fg="black", font=("futura", 17, "bold"))
Title.pack(anchor="center", pady="20px")

length = Label(root, text="Select the Length of Your Password :- ",bg="grey", fg="black", font=("ubuntu", 12, "bold"))
...
result_lable = Label(root, text="Generated Password Here :- ",bg="grey", fg="black", font=("ubuntu", 12, "bold"))
